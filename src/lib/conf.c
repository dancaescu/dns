...
/* name				value					desc										altname		defaulted	next	*/
  ...
  {	"db-host2",		V_(""),					N_("Secondary SQL server hostname (optional)"),				NULL,		0,		NULL	},
  {	"db-host3",		V_(""),					N_("Tertiary SQL server hostname (optional)"),				NULL,		0,		NULL	},
  {	"db-host4",		V_(""),					N_("Quaternary SQL server hostname (optional)"),			NULL,		0,		NULL	},
  {	"db-host-policy",	V_("sequential"),			N_("DB host selection policy: sequential, round-robin, or least-used"),	NULL,		0,		NULL	},
  ...
  {	"cloudflare-soa-table",	NULL,					N_("Optional table containing Cloudflare zone data"),				NULL,		0,		NULL	},
  {	"cloudflare-rr-table",	NULL,					N_("Optional table containing Cloudflare record data"),				NULL,		0,		NULL	},
  {	"cloudflare-default-ns",NULL,					N_("Default NS for synthesized Cloudflare SOA records"),				NULL,		0,		NULL	},
  {	"cloudflare-default-mbox",NULL,					N_("Default mailbox for synthesized Cloudflare SOA records"),			NULL,		0,		NULL	},
