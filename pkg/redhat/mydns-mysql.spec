...
%build
%configure --with-mysql --without-pgsql --enable-static-build
make
...
%changelog
* Wed Nov 19 2025 Dan Caescu <dan.caescu@multitel.net>
- build with --enable-static-build and document Cloudflare schema helpers
